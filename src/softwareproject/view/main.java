...
import softwareproject.controler.RideController;
...
public class main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //softwareproject.model.Client client=new softwareproject.model.Client("hazem","123456");
        //softwareproject.model.Driver driver=new softwareproject.model.Driver ("mohamed","mohmedk112@gmail.com","258963","123456789","123456");
        //driver.addDriver();
        ...
        while (true) {
            ...
            if (userChoice.equals("1")) { // softwareproject.view.SignUp
                ...
                if (userChoice2.equals("1")) {//client
                    ...
                    signUpOption.clientSignUp(userName, email, password);

                    continue;
                    // enter the system
                } else if (userChoice2.equals("2")) {//softwareproject.model.Driver
                    ...
                    signUpOption.driverSignUp(userName, email, password, nationalId, driverLicense);
                        ...
                        while (true) {
                            ...
                            if (clientChoice1 == 1) {
                                ...
                                if (client.getCount() == 0) {
                                  ...
                                  clientController.PickRide(sourceRide, destination, client);
...
//                                        String rateChoice = scan.nextLine();
                            ...
                            while (true) {
                                ...
                                if (driverChoice1 == 1) { // show favourite places
                                    ...
                                    while (true) {
                                        ...
                                        driverController.addFavouriteArea(driver, driverFavouritePlace);
                    ...
                    admin = signInOption.adminSignIN(userName, password);
                    ...
                    if (admin != null) {
                        ...
                        while (true) {
                            ...
                            if (userChoice3.equals("1")) {
                                ...
                                if (adminController.showClientList()) {
                                ...
                                if (adminController.showActiveDrivers()) {
                                    System.out.println(" Choose a client to be 1-Suspended / 2-unSuspended");
                                    int adminChoice = scan.nextInt();
                               ...
                               if(!adminController.showRideEvents()){
